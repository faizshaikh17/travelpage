...
export default function ItenarySection() {
    return (
        <section className="relative w-full bg-[#FAFAFA] min-h-[800px] space-y-6 sm:space-y-8 lg:space-y-16 sm:min-h-[900px] lg:h-[1000px] overflow-hidden px-4 sm:px-8 lg:px-28 py-12 sm:py-16 lg:py-28 rounded-2xl">
            ...
            <div className='h-[0.01rem] my-8 sm:my-12 lg:my-16 w-full bg-neutral-300'></div>
            ...
            <div className='flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-20'>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full lg:max-w-xl">
                    {features.map((feature) => (
                        <div key={feature.id} className="bg-white border border-neutral-200 rounded-2xl p-4 sm:p-5 w-full shadow-xs h-full flex flex-col gap-3 sm:gap-4">
                ...
                <div className="relative w-full max-w-md sm:max-w-lg lg:w-[35rem] aspect-[35/33] lg:h-[33rem]">
                    <Image
